              ...
              <div class="circle-tile-content lightblue">
                <div class="circle-tile-description text-faded">
                  ...
                  <div class="circle-tile-number text-faded up">
                    <span class="overview" id="b-hashrate">{$GLOBAL.userdata.hashrate|number_format:"0"}</span>
          ...
          <div class="col-lg-2 col-sm-6">
            <div class="circle-tile fade">
              <div class="circle-tile-heading lightblue">
               <a class="text-link" href="{$GLOBAL.statsurl}" target="_blank"><i class="fa fa-h-square fa-fw fa-2x"></i></a>
              </div>
              <div class="circle-tile-content lightblue">
                <div class="circle-tile-description text-faded">
          ...
          <div class="col-lg-2 col-sm-6">
            <div class="circle-tile fade">
              <div class="circle-tile-heading lightblue">
               <a class="text-link" href="{$GLOBAL.config.exchangebtcurl}" target="_blank"><i class="fa fa-btc fa-fw fa-2x"></i></a>
              </div>
              <div class="circle-tile-content lightblue">
                <div class="circle-tile-description text-faded">
                  <p class="h5 up-more">{$GLOBAL.config.currency}/{$GLOBAL.config.price.btccurrency}</p>
                  <div class="circle-tile-number text-faded up">
            ...
            <div class="circle-tile fade">
              ...
              <div class="circle-tile-content lightblue">
                <div class="circle-tile-description text-faded">
                  ...
                  <div class="circle-tile-number text-faded up">
                    <span class="h6 overview" id="b-price">{$GLOBAL.price|default:"0"|number_format:"2"}</span>
                    <br>
                    <span class="coin-price-line spark-25"></span>
                  </div>
                </div>
