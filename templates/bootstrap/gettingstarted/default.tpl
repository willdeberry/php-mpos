    ...
    <div class="col-lg-12">
        <div class="panel panel-info">
            ...
            <div class="panel-body">
                ...
                <ul>
                    <li><em>veriumMiner (github):</em><a href="https://github.com/fireworm71/veriumMiner/releases" target="_blank"> Download here</a>.</li>
                </ul>
                </li>
                <p>3. <strong>Configure your miner.</strong></p>
                <ul>
                <li>cpuminer-multi <em>(Linux)</em></li>
                <pre>./cpuminer -o stratum+tcp://{$SITESTRATUMURL|default:$smarty.server.SERVER_NAME}:{$SITESTRATUMPORT|default:"3334"} -O <em>Weblogin</em>.<em>WorkerName</em>:<em>WorkerPassword</em></pre>
                <br />
