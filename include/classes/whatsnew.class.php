...
class Whatsnew extends Base {
  ...
  public function __construct($config) {
    ...
    $this->table = $this->config['db']['shared']['whatsnew'] . '.' . $this->table;
  }
...
$whatsnew = new Whatsnew($config);
$whatsnew->setDebug($debug);
$whatsnew->setMysql($mysqli);
$whatsnew->setUser($user);
$whatsnew->setErrorCodes($aErrorCodes);
