...
// Small helper array
$aHashunits = array( '60000' => 'H/m', '10' => 'H/s', '1' => 'KH/s', '0.001' => 'MH/s', '0.000001' => 'GH/s', '0.000000001' => 'TH/s', '0.000000000001' => 'PH/s', '0.000000000000001' => 'EH/s' );
...
$aGlobal = array(
  ...
  'vrcprice' => $setting->getValue('vrcprice'),
  'vrcbtcprice' => $setting->getValue('vrcbtcprice'),
  'vrceuroprice' => $setting->getValue('vrceuroprice'),
  ...
  'config' => array(
    ...
    'exchangevrcurl' => $config['price']['url'] . $config['price']['vrctarget'],
    'exchangevrcbtcurl' => $config['price']['btcurl'] . $config['price']['vrcbtctarget'],
